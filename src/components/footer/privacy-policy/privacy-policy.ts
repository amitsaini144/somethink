export const privacyPolicyContent = [
    ...
    },
    {
      id: 6,
      description:
        'You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Somethinknow.com .',
    },
    {
      id: 7,
      description:
    ...
    },
    {
      id: 11,
      description:
        'Email address First name and last name Usage Data is collected automatically when using the Service.',
    },
    {
      id: 12,
      description:
